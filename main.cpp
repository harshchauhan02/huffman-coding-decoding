 ...
 *
 * Directly used to implement the 'build_tree()' routine.
 *
 ...
 *
 * Binary codes are represented by vector<bool>, which is a specialized
...
string tests[] = {
    "Hi harsh can you read ur messages",
    "We hold these truths to be b"
};
